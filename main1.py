...
if __name__ == "__main__":
    ...
    parser.add_argument("-rdd_time", type=float, help="RDD Data time (s)", default=90)
    ...
    test_loader = torch.utils.data.DataLoader(test_set, batch_size=9, shuffle=False, num_workers=2)

    train_set_2    = torchvision.datasets.CIFAR10(root='../Data', train=True, download=True, transform=transform_test)
    train_loader_2 = torch.utils.data.DataLoader(train_set_2, batch_size=9, shuffle=True, num_workers=2)
    ...
    if folder is not None:
        ...
        with open(os.path.join(folder, "params.txt"), "w") as f:
            ...
            f.write("RDD Data time: {} s\n".format(rdd_time))
            f.write("Do RDD Data every epoch: {} s\n".format(rdd_every_epoch))
    ...
    def train_fb():
        ...
        print("Performing RDD Data pre-training for {} s...".format(rdd_time))

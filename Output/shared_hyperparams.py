...
u_window        = 10                # input drive window used to determine near-threshold data points for RDD Data
...
RDD_window      = 0.03/dt           # RDD Data integration window length (timesteps)
RDD_init_window = 0.1               # window around spike threshold that determines when an RDD Data integration window is initiated
...
RDD_eta         = 0.001             # RDD Data learning rate